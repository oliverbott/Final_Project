...
## Data
<br>
We pulled and cleaned follower data, patent data, and some other variables for 130 cities to see if we can find a relationship between follower and patent data, and these and 'explanatory' variables
...
<br>
 ...
 - Hard to parse whether relationships or findings with current data limitations
 - 
...
- The field in the future may move away from patents
