...
eumap <- qmap(c(lon=europe.center$lon, lat=europe.center$lat), source='google', maptype = 'satellite', zoom=4)
...
japanmap <- qmap(c(lon=japan.center$lon, lat=japan.center$lat), source='google', maptype = 'satellite', zoom=5)
...
americamap <- qmap(c(lon=america.center$lon, lat=america.center$lat), source='google', maptype = 'satellite', zoom=3)
...
labelsP <- c('(Intercept)', 'Over 20 Followers', 'GDP', 'Population', 'Greenspace', 'Employment', 'Pollution')

stargazer::stargazer(P1, P2, covariate.labels = labelsP,
  title = 'Regression Estimates of Patent Activity',
  digits = 2, type ='html', header=FALSE, single.row=TRUE)
```
