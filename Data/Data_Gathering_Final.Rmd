...
# Rename columns
colnames(location_counts11) <- c("METRO_ID" , "Patents" , "GDP" , "Population", "Greenspace", "Employment" , "Pollution" , "lon" , "lat" , "Followers" , "1" , "10" , "20" , "30" , "40" , "50" , "60" , "70" , "80" , "80" , "90" , "100" , "US" , "DE" , "FR" , "JP" )

# Make new variable with over 20 followers per 10,000 population
over20 <- subset(dataset, select = c("METRO_ID","20"))
